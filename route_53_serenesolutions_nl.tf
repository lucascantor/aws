...
resource "aws_route53_record" "smtp_tls_serenesolutions_nl__TXT" {
  ...
  ttl     = "3600"
  records = [
    "v=TLSRPTv1; rua=mailto:cantor-d@tlsrpt.report-uri.com,mailto:mta-sts@serenesolutions.nl",
  ]
}
...
resource "aws_route53_record" "mta_sts_serenesolutions_nl__TXT" {
  ...
  ttl     = "3600"
  records = [
    "v=STSv1; id=${time_static.mta_sts_serenesolutions_nl__TXT.unix};",
  ]
}
