...
resource "aws_route53_record" "dmarc_hunterscreekapartments_net__TXT" {
  ...
  ttl     = "3600"
  records = [
    "v=DMARC1; p=reject; rua=mailto:dmarc@hunterscreekapartments.net,mailto:cantor-d@dmarc.report-uri.com,mailto:3bb7ee9fe7cbd3cd3bfe059a02609870@snowy-hill-2286.tines.email; ruf=mailto:dmarc@hunterscreekapartments.net; fo=1; pct=100; adkim=s; aspf=s",
  ]
}
