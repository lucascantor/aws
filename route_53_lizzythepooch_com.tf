...
resource "aws_route53_record" "dmarc_lizzythepooch_com__TXT" {
  ...
  ttl     = "3600"
  records = [
    "v=DMARC1; p=reject; rua=mailto:dmarc@lizzythepooch.com,mailto:cantor-d@dmarc.report-uri.com; ruf=mailto:dmarc@lizzythepooch.com; fo=1; pct=100; adkim=s; aspf=s",
  ]
}
